...
enum class AddBottomSheetKeys(var colName: String? = null, var docName: String? = null, var imageID: Int? = null){
    ...
    UPDATE_BLOODSUCKER(imageID = 666), UPDATE_SPENDING_CARD, UPDATE_PIGGY, UPDATE_EARNINGS, UPDATE_BALANCE(imageID = 1313),
    ADD_EARNING
}

enum class ListBottomSheetKeys{
    CATEGORY_SETTINGS, PIGGY_BANK_SETTINGS, EARNINGS_SETTINGS, CHANGE_LANGUAGE, CHANGE_CURRENCY
}